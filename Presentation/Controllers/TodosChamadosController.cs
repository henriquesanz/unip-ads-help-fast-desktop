...
public class TodosChamadosController : BaseController
{
    private readonly ISessionService _sessionService;
    private readonly IChamadoService _chamadoService;
    private TodosChamadosModel _model;

    public TodosChamadosController(IServiceProvider serviceProvider) : base(serviceProvider)
    {
        ...
        _model = new TodosChamadosModel();
    }

    public TodosChamadosModel GetModel() => _model;
...
public class TodosChamadosModel : INotifyPropertyChanged
{
