...
public partial class ChamadosAtribuidosForm : Form
{
    private readonly ISessionService _sessionService;
    private readonly IChamadoService _chamadoService;

    public ChamadosAtribuidosForm(ISessionService sessionService, IChamadoService chamadoService)
    {
    ...
    private async void LoadChamados()
    {
        try
        {
            ...
            var chamados = await _chamadoService.ListarChamadosAtribuidosAsync(_sessionService.UsuarioLogado.Id);
